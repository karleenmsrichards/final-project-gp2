...
export function HomeCardGrid() {
  ...
  return (
    <Container>
      <Typography gutterBottom variant="h5" sx={{ fontSize: "18px" }}>Experts loved by customers</Typography>
            ...
            <Card sx={{ maxWidth: 300, borderRadius: "20px" }}>
              ...
              <Box
                ...
                <Box
                  ...
                  >
                    <FavoriteIcon fontSize="small" sx={{ color: "black" }} /> {/* Heart icon */}
                  </Box>
                ...
                <CardContent sx={{ padding: 0 }}>
                  ...
                  <Typography variant="body2" color="text.secondary" sx={{ marginBottom: "10px", marginTop: "0px" }}>
                    {data.location}
                  </Typography>
                  <Link href={data.link} underline="none" sx={{ color: "black" }}>
                    <Box
                      display="flex"
                      alignItems="center"
                      py={1}
                    ...
                    >
                      <Typography gutterBottom variant="p" component="div" sx={{ fontSize: "18px" }}>
                        {data.session}
                      </Typography>
